...
function Promt({
  ...
  if (chatLoading)
    return (
      <div className="flex w-full h-full flex-col gap-4 pt-4 p-2">
        <div className="flex justify-end ">
          <div className="skeleton h-10 w-[30%] bg-white/20"></div>
        </div>
        <div className="skeleton h-15 w-[80%] bg-white/20"></div>
        <div className="flex justify-end">
          <div className="skeleton h-25 w-[60%] bg-white/20"></div>
        </div>
        <div className="skeleton h-50 w-[80%] bg-white/20"></div>
        <div className="flex justify-end">
          <div className="skeleton h-25 w-[40%] bg-white/20"></div>
        </div>
        ...
        {promt.map((msg, index) => (
          ...
          >
            ...
            {msg.role === "model" ? (
              ...
              <div className="max-w-[60%] bg-blue-600 text-white rounded-lg p-3 text-sm whitespace-pre-wrap self-start">
                {msg.content}
              </div>
            )}
          </div>
